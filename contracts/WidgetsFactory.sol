...
contract WidgetsFactory is ERC20, ERC20Burnable, Ownable {
    
    mapping(address => bool) public _managers;        
    mapping(address => uint256) public _stock;
   ...
   */
    ...
    */
    function OrderPurchase(address orderor, uint256 amount) public {
    ...
    */
    function OrderShip() public {
        require(_managers[_msgSender()] == true, "It should be manager");
